...
| P1 | Introduce bounded/paginated advanced gateway read models after console callers are incremental. | Planned | Stable DTO migration, query-plan evidence, browser projection tests. |
...
5. Continue extracting client/setup views from the connected console, then run
